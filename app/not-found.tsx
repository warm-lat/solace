        ...
        <div className="flex flex-col items-center gap-6 max-w-2xl w-full text-center animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 backdrop-blur-md bg-white/10 border border-white/20 text-white px-6 py-3 rounded-lg font-medium hover:bg-white/20 transition-all hover:scale-105"
            >
